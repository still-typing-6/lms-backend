...
import { createCourseController, deleteCourseController, updateCourseController } from "../controllers/course.controller.js";
...
courseRouter.delete("/course/:courseId", middleware, roleAuthMiddleware("Teacher"), courseOwnerMiddleware, deleteCourseController);
